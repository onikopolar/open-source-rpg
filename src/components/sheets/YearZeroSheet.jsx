...
function YearZeroSheet({
  ...
  console.log('[YearZeroSheet] Versao 1.1.0 - Feature: Adicionado EquipmentNotepad modal');
  ...
  const handleEquipmentSave = async (type, value) => {
    if (onUpdate) {
  ...
  return (
    <>
      ...
      {/* Modal de Notepad para Equipamentos */}
      <EquipmentNotepad
        character={character}
