...
export const handleYearZeroUpdate = async (character, rpgSystem, setCharacter, setYearZeroAttributeValues, setYearZeroSkillValues, type, name, value) => {
  ...
  console.log('[YearZero Handlers] Versao 1.0.1 - Fix: Suporte completo para valor 0')
...
export const handleYearZeroSkillRoll = (character, yearZeroDiceModal, skillName, skillValue, stressSquares) => {
  ...
  const skillToAttributeMap = {
    "COMBATE CORPO A CORPO": "Forca",
    "MAQUINARIO PESADO": "Forca",
    "RESISTENCIA": "Forca",
    "COMBATE A DISTANCIA": "Agilidade",
    "MOBILIDADE": "Agilidade",
    "PILOTAGEM": "Agilidade",
    "OBSERVACAO": "Inteligencia",
    "SOBREVIVENCIA": "Inteligencia",
    "TECNOLOGIA": "Inteligencia",
    "MANIPULACAO": "Empatia",
    "COMANDO": "Empatia",
    "AJUDA MEDICA": "Empatia"
  };
  
  const relatedAttribute = skillToAttributeMap[skillName] || 'Forca';
